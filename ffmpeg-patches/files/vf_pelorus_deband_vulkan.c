...
static av_cold int init_filter(AVFilterContext *ctx)
{
    ...
    RET(ff_vk_shader_link(vkctx, shd, ff_pelorus_deband_comp_spv_data,
...
static const AVOption pelorus_deband_vulkan_options[] = {
    {"range",
     "reference-sampling radius in pixels",
     OFFSET(opts.range),
     AV_OPT_TYPE_INT,
     {.i64 = 15},
     1,
    ...
    {"thrc",
     ...
     FLAGS},
    {"grainy",
     "luma grain amplitude (normalized)",
     OFFSET(opt_grain_y),
     AV_OPT_TYPE_DOUBLE,
     {.dbl = 0.006},
     0.0,
     ...
     FLAGS},
    {"grainc",
     "chroma grain amplitude (normalized)",
     OFFSET(opt_grain_c),
     AV_OPT_TYPE_DOUBLE,
     {.dbl = 0.0},
     0.0,
     ...
     FLAGS},
    {"softness",
     "soft-blend transition width (0=hard switch)",
     OFFSET(opts.softness),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 0.5},
     0.0,
     1.0,
     FLAGS},
    {"detail",
     "detail-mask activity threshold (normalized)",
     OFFSET(opts.detail_thr),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 0.06},
     0.0,
     0.25,
     FLAGS},
    {"sample",
     "reference-tap topology",
     OFFSET(opts.sample_mode),
     AV_OPT_TYPE_INT,
     {.i64 = 2},
     1,
     4,
    ...
    {"dynamic",
     "re-seed grain each frame",
     OFFSET(dynamic_grain),
     AV_OPT_TYPE_BOOL,
     {.i64 = 1},
     0,
     1,
     FLAGS},
    {"protect",
     "gate debanding off textured regions",
