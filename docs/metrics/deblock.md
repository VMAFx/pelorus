...
One Vulkan compute dispatch. Descriptor-derived conversion puts samples in the
logical `[0,1]` domain before thresholding. At
...
`ffmpeg-patches/files/vulkan/pelorus_deblock.comp.glsl`; the similarly named
